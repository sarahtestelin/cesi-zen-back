...
public class DiagnosticController {
  ...
  public DiagnosticResponseDto calculateAnonymous(
  ...
  public DiagnosticResponseDto calculateAndSave(
      @Valid @RequestBody DiagnosticRequestDto request, @AuthenticationPrincipal Jwt jwt) {
  ...
  @PreAuthorize("hasRole('ADMIN')")
  public DiagnosticQuestionResponseDto createQuestion(
  ...
  public DiagnosticQuestionResponseDto updateQuestion(
      @PathVariable UUID id, @Valid @RequestBody DiagnosticQuestionRequestDto request) {
  ...
  public DiagnosticResultConfigResponseDto updateResultConfig(
      @PathVariable UUID id, @Valid @RequestBody DiagnosticResultConfigRequestDto request) {
