...
public class AppUserController {
  ...
  public AppUserDto updateCurrentUser(
      @AuthenticationPrincipal Jwt jwt, @Valid @RequestBody UpdateCurrentUserDto dto) {
  ...
  public AppUserDto updateUser(
      @PathVariable UUID id, @RequestBody AppUserDto appUserDto, @AuthenticationPrincipal Jwt jwt) {
  ...
  @PreAuthorize("hasRole('ADMIN')")
  public AppUserDto disableUser(@PathVariable UUID id, @AuthenticationPrincipal Jwt jwt) {
    return appUserService.disableUser(id, jwt.getSubject());
  }

  @PatchMapping("/{id}/enable")
  @PreAuthorize("hasRole('ADMIN')")
  public AppUserDto enableUser(@PathVariable UUID id, @AuthenticationPrincipal Jwt jwt) {
    return appUserService.enableUser(id, jwt.getSubject());
  }

  @PatchMapping("/{id}/promote")
  @PreAuthorize("hasRole('ADMIN')")
  public AppUserDto promoteUser(@PathVariable UUID id, @AuthenticationPrincipal Jwt jwt) {
    return appUserService.promoteUser(id, jwt.getSubject());
  }

  @PatchMapping("/{id}/demote")
  @PreAuthorize("hasRole('ADMIN')")
  public AppUserDto demoteUser(@PathVariable UUID id, @AuthenticationPrincipal Jwt jwt) {
