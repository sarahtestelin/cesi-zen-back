...
public class AuthServiceImpl implements AuthService {
  ...
  public AuthResponseDto register(RegisterUserDto dto) {
    ...
    return new AuthResponseDto(accessToken, refreshToken, UserMapper.toDto(savedUser));
  }
  ...
  public AuthResponseDto refresh(String refreshTokenValue) {
    ...
    return new AuthResponseDto(newAccessToken, newRefreshToken, UserMapper.toDto(user));
  }
